var popover;
function popoverService($, parseInt, getComputedStyle, TweenMax, _, undefined) {
	...
	const mainMenuPopovers = {
		...
		'bar-stats': () => '[' + _.capitalize(String.fromCharCode(ng.config.hotkey.characterStats)) + '] Character Sheet',
		'bar-inventory': () => '[' + _.capitalize(String.fromCharCode(ng.config.hotkey.inventory)) + '] Inventory',
...
popoverService($, parseInt, getComputedStyle, TweenMax, _)
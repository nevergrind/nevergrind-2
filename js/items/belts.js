	...
	unique: [
		{
			...
			cha: [8, 12],
			intel: 9,
			resistFire: [7, 15].map(util.divideBy4),
			resistLightning: [7, 15].map(util.divideBy4),
			resistIce: [7, 15].map(util.divideBy4),
			addSpellFire: [5, 8],
		}, {
			name: 'Belt',
			newName: 'Snakecord',
			...
			hpRegen: 1,
			magMit: 4,
			resistPoison: [9, 12].map(util.divideBy4),
			resistBlood: [9, 12].map(util.divideBy4),
			defense: [1, 2],
			wraith: [3, 4],
		}, {
			name: 'Heavy Belt',
			...
			resistFire: [11, 15].map(util.divideBy4),
			offense: [1, 2],
		}, {
			name: 'Kusari Belt',
			...
			enhancedArmor: [17, 25],
			wis: 10,
			resistIce: [17, 21].map(util.divideBy4),
			addSpellIce: [5, 8],
			...
			hpKill: [4, 6],
			dodge: 3,
			resistLightning: [9, 13].map(util.divideBy4),
			resistArcane: [13, 17].map(util.divideBy4),
			addSpellAll: [2, 4],
		}, {
			name: 'Bronze Belt',
			...
			resistLightning: [11, 20].map(util.divideBy4),
		}, {
			name: 'Chain Belt',

	...
	unique: [
		{
			...
			piercing: 2,
			resistStun: [5, 8],
			resistBlood: [25, 30].map(util.divideBy4),
			...
			str: [17, 25],
			allSkills: 1,
			resistFire: [18, 24].map(util.divideBy4),
			resistIce: [18, 24].map(util.divideBy4),
			resistArcane: [12, 16].map(util.divideBy4),
			resistLightning: [15, 25].map(util.divideBy4),
			leech: [2, 3],
			wraith: [2, 3],
		}, {
			name: 'Linen Robe',
			...
			resistLightning: [15, 20].map(util.divideBy4),
			...
			wraith: [3, 5],
			mpKill: [4, 7],
			resistLightning: [35, 42].map(util.divideBy4),
			resistArcane: [25, 35].map(util.divideBy4),
			resistFire: [36, 50].map(util.divideBy4),
			allSkills: 1,

...
!function($, _, TweenMax, Object, undefined) {
		...
		CRU: [
			{
				...
				hitBonus: [0, 4, 4.5, 5, 5.5, 6, 6.5, 7],
				cooldownTime: 30,
				description: 'Precise shield slam with a 10% chance to stagger.',
			}, {
				name: 'Rebuke',
				img: 'CRU-2',
		...
		SHD: [
			{
				...
				name: 'Brain Hew',
				img: 'SHD-5',
				mp: level => spellValues.brainHewMana[level],
				spellDamage: level => spellValues.brainHew[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
	...
	const spellValues = {
		// SHD
		shadowBreakMana: getManaTier(.8),
		deathStrikeMana: getManaTier(.8),
		crescentCleaveMana: getManaTier(.8),
		doomThrustMana: getManaTier(.8),
		brainHewMana: getManaTier(1.4),
		brainHew: [0, 20, 44, 103, 178, 271, 334, 394],

...
!function($, _, TweenMax, Object, undefined) {
		...
		SHD: [
			{
				...
				spellDamage: level => spellValues.astralBlade[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				...
				name: 'Decaying Doom',
				img: 'SHD-8',
				mp: level => spellValues.bloodTerrorMana[level],
				...
				name: 'Life Tap',
				img: 'SHD-10',
				sp: level => spellValues.vampiricLustMana[level],
				spellDamage: level => spellValues.vampiricLust[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				damageType: DAMAGE_TYPE.FIRE,
				castTime: 3,
				...
				name: 'Vampiric Lust',
				img: 'SHD-11',
				sp: level => spellValues.bloodFeastMana[level],
				spellDamage: level => spellValues.bloodFeast[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				damageType: DAMAGE_TYPE.FIRE,
				castTime: 3,
				...
				name: 'Blood Feast',
				img: 'SHD-12',
				sp: level => spellValues.markOfRemphanMana[level],
		...
		WLK: [
			{
				...
				castTime: 3,
				cooldownTime: 8,
				description: 'Hit single target for X arcane damage - drains health to yourself - Cannot resist',
			}, {
				name: 'Lich Form',
				img: 'WLK-10',
	...
	const spellValues = {
		...
		astralBladeMana: getManaTier(1.4),
		astralBlade: [0, 20, 44, 103, 178, 271, 334, 394],
		ravagingPlagueMana: getManaTier(1.4),
		ravagingPlague: [0, 20, 44, 103, 178, 271, 334, 394],
		decayingDoomMana: getManaTier(1.4),
		decayingDoom: [0, 20, 44, 103, 178, 271, 334, 394],
		bloodTerrorMana: getManaTier(1.4),
		bloodTerror: [0, 20, 44, 103, 178, 271, 334, 394],
		lifeTapMana: getManaTier(1.4),
		lifeTap: [0, 20, 44, 103, 178, 271, 334, 394],
		vampiricLustMana: getManaTier(1.4),
		vampiricLust: [0, 20, 44, 103, 178, 271, 334, 394],
		bloodFeastMana: getManaTier(1.4),
		bloodFeast: [0, 20, 44, 103, 178, 271, 334, 394],
		markOfRemphanMana: getManaTier(1.4),
		markOfRemphan: [0, 20, 44, 103, 178, 271, 334, 394],
		// CRU

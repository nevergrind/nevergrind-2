...
!function($, _, TweenMax, Object, undefined) {
		...
		BRD: [
			{
				...
				img: 'BRD-7',
				sp: level => spellValues.militantCadenceMana[level],
				...
				name: 'Requiem of Restraint',
				img: 'BRD-8',
				sp: level => spellValues.requiemOfRestraintMana[level],
				spellDamage: level => spellValues.requiemOfRestraint[level] + (my.level),
				spellVariance: .91,
				spellType: 'conjuration',
				damageType: 'arcane',
				castTime: 3,
	...
	const spellValues = {
		...
		battleHymnMana: getManaTier(.2),
		battleHymn: NoDamage,
		militantCadenceMana: getManaTier(.2),
		militantCadence: NoDamage,
		requiemOfRestraintMana: getManaTier(1.5),
		requiemOfRestraint: [0, 26, 63, 152, 272, 401, 516, 603],

...
!function($, _, TweenMax, Object, undefined) {
		...
		DRU: [
			{
				...
				name: 'Barbed Thicket',
				img: 'DRU-7',
				sp: level => spellValues.barbedThicketMana[level],
				...
				name: 'Tornado',
				img: 'DRU-8',
				sp: level => spellValues.tornadoMana[level],
		...
		SHM: [
			{
				...
				name: 'Affliction',
				img: 'SHM-7',
				sp: level => spellValues.afflictionMana[level],
				...
				img: 'SHM-8',
				sp: level => spellValues.devouringSwarmMana[level],
		...
		NEC: [
			{
				...
				castTime: 3.5,
				cooldownTime: 0,
				description: 'Scorch your target for X fire damage and additional fire damage over time - Effect: Reduces armor by X.',
			}, {
				name: 'Demonic Pact',
				img: 'NEC-4',
				...
				castTime: 4.5,
				cooldownTime: 15,
				description: 'Hits target for X blood damage - small blood damage over X seconds - lowers target PR, BR, AR.',
			}, {
				...
				img: 'NEC-6',
				mp: level => spellValues.summonSkeletonMana[level],
				spellDamage: level => spellValues.summonSkeleton[level] + (my.level),
				spellVariance: .875,
				spellType: 'conjuration',
				damageType: 'fire',
				castTime: 3,
				...
				name: 'Sanguine Pact',
				img: 'NEC-7',
				sp: level => spellValues.sanguinePactMana[level],
				spellDamage: level => spellValues.sanguinePact[level] + (my.level),
				spellVariance: .875,
				spellType: 'conjuration',
				damageType: 'fire',
				castTime: 3,
				...
				img: 'NEC-8',
				sp: level => spellValues.gleamOfMadnessMana[level],
				spellDamage: level => spellValues.gleamOfMadness[level] + (my.level),
				spellVariance: .875,
				spellType: 'conjuration',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.drainSoul[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
				...
				img: 'NEC-10',
				sp: level => spellValues.breathOfTheDeadMana[level],
				spellDamage: level => spellValues.breathOfTheDead[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
				...
				img: 'NEC-11',
				sp: level => spellValues.defiledSpiritMana[level],
				spellDamage: level => spellValues.defiledSpirit[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
				...
				name: 'Defiled Spirit',
				img: 'NEC-12',
				sp: level => spellValues.bloodSacrificeMana[level],
				spellDamage: level => spellValues.bloodSacrifice[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
	...
	const spellValues = {
		...
		hauntingVision: [0, 15, 37, 89, 159, 235, 303, 354],
		summonSkeletonMana: getManaTier(1.2),
		summonSkeleton: [0, 15, 37, 89, 159, 235, 303, 354],
		sanguinePactMana: getManaTier(1.2),
		sanguinePact: [0, 15, 37, 89, 159, 235, 303, 354],
		gleamOfMadnessMana: getManaTier(1.2),
		gleamOfMadness: [0, 15, 37, 89, 159, 235, 303, 354],
		drainSoulMana: getManaTier(1.2),
		drainSoul: [0, 15, 37, 89, 159, 235, 303, 354],
		breathOfTheDeadMana: getManaTier(1.2),
		breathOfTheDead: [0, 15, 37, 89, 159, 235, 303, 354],
		defiledSpiritMana: getManaTier(1.2),
		defiledSpirit: [0, 15, 37, 89, 159, 235, 303, 354],
		bloodSacrificeMana: getManaTier(1.2),
		bloodSacrifice: [0, 15, 37, 89, 159, 235, 303, 354],
		// shm
		...
		vampiricAllure: [0,0,0,0,0,0,0,0],
		borealTalismanMana: getManaTier(1.8),
		borealTalisman: [0,0,0,0,0,0,0,0],
		// dru

...
!function($, _, TweenMax, Object, undefined) {
	const NO_DAMAGE = [0,0,0,0,0,0,0,0]
	skills = {
		init,
		getName,
		notReady,
		...
		BRD: [
			{
				...
				spellDamage: level => spellValues.euphonicDirge[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.subvertedSymphony[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.battleHymn[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				name: 'Victory Jaunt',
				img: 'BRD-7',
				sp: level => spellValues.victoryJauntMana[level],
				spellDamage: level => spellValues.victoryJaunt[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				name: 'Shackle Chords',
				img: 'BRD-8',
				sp: level => spellValues.shackleChordsMana[level],
				spellDamage: level => spellValues.shackleChords[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.litanyOfLife[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.melodyOfMana[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.righteousRhapsody[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				img: 'BRD-12',
				sp: level => spellValues.chromaticSonnetMana[level],
				spellDamage: level => spellValues.chromaticSonnet[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
	...
	const spellValues = {
		...
		euphonicDirgeMana: getManaTier(1.1),
		euphonicDirge: [0, 17, 42, 101, 181, 267, 344, 402],
		subvertedSymphonyMana: getManaTier(1.1),
		subvertedSymphony: [0, 17, 42, 101, 181, 267, 344, 402],
		crashingChordsMana: getManaTier(1.1),
		crashingChords: [0, 17, 42, 101, 181, 267, 344, 402],
		battleHymnMana: getManaTier(1.1),
		battleHymn: [0, 17, 42, 101, 181, 267, 344, 402],
		victoryJauntMana: getManaTier(1.1),
		victoryJaunt: [0, 17, 42, 101, 181, 267, 344, 402],
		shackleChordsMana: getManaTier(1.1),
		shackleChords: [0, 17, 42, 101, 181, 267, 344, 402],
		litanyOfLifeMana: getManaTier(1.1),
		litanyOfLife: [0, 17, 42, 101, 181, 267, 344, 402],
		melodyOfManaMana: getManaTier(1.1),
		melodyOfMana: [0, 17, 42, 101, 181, 267, 344, 402],
		righteousRhapsodyMana: getManaTier(1.1),
		righteousRhapsody: [0, 17, 42, 101, 181, 267, 344, 402],
		chromaticSonnetMana: getManaTier(1.1),
		chromaticSonnet: [0, 17, 42, 101, 181, 267, 344, 402],
		// TMP
		...
		moltenAegis: NO_DAMAGE,
		convictionMana: getManaTier(1.6),
		conviction: NO_DAMAGE,
		celestialFrenzyMana: getManaTier(2),
		celestialFrenzy: NO_DAMAGE,
		// ENC
		...
		phaseBlade: NO_DAMAGE,
		stasisFieldMana: getManaTier(1.7),
		stasisField: NO_DAMAGE,
		...
		vampiricAllure: NO_DAMAGE,
		borealTalismanMana: getManaTier(1.8),
		borealTalisman: NO_DAMAGE,
		// DRU

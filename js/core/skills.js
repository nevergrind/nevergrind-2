...
!function($, _, TweenMax, Object, undefined) {
		...
		NEC: [
			{
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Hits 3x targets: on death (tainted) explodes X poison damage',
			}, {
				name: 'Blood Fire',
				img: 'NEC-3',
				mp: level => spellValues.starfireMana[level],
	...
	const spellValues = {
		...
		explosivePlagueMana: getManaTier(1.2),
		explosivePlague: [0, 15, 37, 89, 159, 235, 303, 354],
		bloodFireMana: getManaTier(1.2),
		bloodFire: [0, 15, 37, 89, 159, 235, 303, 354],
		demonicPactMana: getManaTier(1.2),
		demonicPact: [0, 15, 37, 89, 159, 235, 303, 354],

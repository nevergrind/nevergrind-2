...
!function($, _, TweenMax, Object, undefined) {
		...
		TMP: [
			{
				...
				spellDamage: level => spellValues.fireWall[level] + (my.level),
				spellVariance: .875,
				spellType: 'conjuration',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.glacialSpike[level] + (my.level),
				spellVariance: .875,
				spellType: 'conjuration',
				damageType: 'fire',
				castTime: 3,
				...
				name: 'Lava Shield',
				img: 'TMP-10',
				sp: level => spellValues.lavaShieldMana[level],
				spellDamage: level => spellValues.lavaShield[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
				...
				name: 'Lucid Synergy',
				img: 'TMP-11',
				sp: level => spellValues.lucidEnergyMana[level],
				spellDamage: level => spellValues.lucidEnergy[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
				...
				img: 'TMP-12',
				sp: level => spellValues.etherealFocusMana[level],
				spellDamage: level => spellValues.etherealFocus[level] + (my.level),
				spellVariance: .875,
				spellType: 'alteration',
				damageType: 'fire',
				castTime: 3,
	...
	const spellValues = {
		...
		staticStormMana: getManaTier(1.2),
		staticStorm: [0, 14, 36, 85, 153, 226, 291, 340],
		fireWallMana: getManaTier(1.2),
		fireWall: [0, 14, 36, 85, 153, 226, 291, 340],
		glacialSpikeMana: getManaTier(1.2),
		glacialSpike: [0, 14, 36, 85, 153, 226, 291, 340],
		primordialSludgeMana: getManaTier(1.2),
		primordialSludge: [0, 14, 36, 85, 153, 226, 291, 340],
		arclightMana: getManaTier(1.2),
		arclight: [0, 14, 36, 85, 153, 226, 291, 340],
		primevalWitheringMana: getManaTier(1.2),
		primevalWithering: [0, 14, 36, 85, 153, 226, 291, 340],
		lavaShieldMana: getManaTier(1.2),
		lavaShield: [0, 14, 36, 85, 153, 226, 291, 340],
		lucidEnergyMana: getManaTier(1.2),
		lucidEnergy: [0, 14, 36, 85, 153, 226, 291, 340],
		etherealFocusMana: getManaTier(1.2),
		etherealFocus: [0, 14, 36, 85, 153, 226, 291, 340],
		// ENC
		...
		phaseBlade: [0,0,0,0,0,0,0,0],
		stasisFieldMana: getManaTier(1.7),
		stasisField: [0,0,0,0,0,0,0,0],

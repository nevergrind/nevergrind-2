...
!function($, _, TweenMax, Object, undefined) {
		...
		CRU: [
			{
				...
				name: 'Sanctuary',
				img: 'CRU-9',
				sp: level => spellValues.sanctuaryMana[level],
				spellDamage: level => spellValues.sanctuary[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				damageType: DAMAGE_TYPE.FIRE,
				castTime: 3,
				...
				spellDamage: level => spellValues.divineGrace[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				damageType: DAMAGE_TYPE.FIRE,
				castTime: 3,
				...
				spellDamage: level => spellValues.benevolence[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				damageType: DAMAGE_TYPE.FIRE,
				castTime: 3,
				...
				spellDamage: level => spellValues.jubilee[level] + (my.level),
				spellVariance: .875,
				spellType: PROP.EVOCATION,
				damageType: DAMAGE_TYPE.FIRE,
				castTime: 3,
	...
	const spellValues = {
		...
		sealOfDamnationMana: getManaTier(1.3),
		holyWrathMana: getManaTier(1.3),
		divineJudgmentMana: getManaTier(1.3),
		divineJudgment: [0, 9, 20, 47, 81, 123, 152, 179],
		blessedHammerMana: getManaTier(1.6),
		blessedHammer: [0, 19, 49, 117, 207, 307, 396, 461],
		sanctuaryMana: getManaTier(1.2),
		sanctuary: [0, 21, 42, 95, 172, 255, 318, 382],
		divineGraceMana: getManaTier(1.7),
		divineGrace: [0, 33, 67, 152, 275, 408, 508, 611],
		benevolenceMana: getManaTier(2.5),
		benevolence: [0, 4, 8, 13, 19, 26, 34, 45],
		jubileeMana: getManaTier(2.5),
		jubilee: [0, 4, 8, 13, 19, 26, 34, 45],
		// BRD

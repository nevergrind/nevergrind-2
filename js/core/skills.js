...
!function($, _, TweenMax, Object, undefined) {
		...
		SHM: [
			{
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Curse a single target - all targets are healed when they melee the target for X health for X seconds.',
			}, {
				name: 'Glacial Shard',
				img: 'SHM-6',
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Heal a single target for X health over 8 ticks.',
			}, {
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Buffs single ally - boost leech and wraith by X for X seconds.',
			}, {
	...
	const spellValues = {
		...
		vampiricGazeMana: getManaTier(1.1),
		vampiricGaze: [0, 17, 42, 101, 181, 267, 344, 402],
		...
		rejuvinateMana: getManaTier(1.1),
		rejuvinate: [0, 17, 42, 101, 181, 267, 344, 402],
		mysticalGlowMana: getManaTier(1.1),
		mysticalGlow: [0, 17, 42, 101, 181, 267, 344, 402],
		vampiricAllureMana: getManaTier(1.1),
		vampiricAllure: [0, 17, 42, 101, 181, 267, 344, 402],
		borealTalismanMana: getManaTier(1.1),
		borealTalisman: [0, 17, 42, 101, 181, 267, 344, 402],
		// dru
		...
		naturesTouch: [0, 11, 28, 67, 120, 178, 230, 267],
		mossBreathMana: getManaTier(2.2),
		mossBreath: [0, 11, 24, 59, 107, 158, 203, 237],

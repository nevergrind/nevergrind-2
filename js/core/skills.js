...
!function($, _, TweenMax, Object, undefined) {
		...
		MNK: [
			{
				...
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 30,
				description: 'Hit 3x targets 3 times',
			}, {
				name: 'Dragon Punch',
				img: 'MNK-8',
		...
		ROG: [
			{
				...
				name: 'Evade',
				img: 'ROG-9',
				sp: level => spellValues.ruptureMana[level],
				enhancedDamage: [0, .66, .75, .84, .93, 1.02, 1.11, 1.2],
				hitBonus: [0, 1, 1.5, 2, 2.5, 3, 3.5, 4],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 30,
	...
	const spellValues = {
		...
		craneKickMana: getManaTier(1.4),
		chakraBlastMana: getManaTier(.9),
		hadokenMana: getManaTier(.9),
		hurricaneKicksMana: getManaTier(.9),
		dragonPunchMana: getManaTier(.9),

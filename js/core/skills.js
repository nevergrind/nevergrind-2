		...
		MNK: [
			{
				...
				damageType: DAMAGE_TYPE.FIRE,
				staggers: true,
				description: config => 'Unleash a flaming uppercut on a front-row target hitting three times for '+ config.damageString +' fire damage.',
			}, {
				name: 'Viper Strike',
				img: 'MNK-9',
		...
		CLR: [
			{
				...
				castTime: 4,
				cooldownTime: 8,
				description: config => 'Restore '+ config.damageString +' health to your target and yourself at the same time. You must target an ally to begin casting.',
			}, {
				name: 'Guardian Angel',
				img: 'CLR-8',

...
!function($, _, TweenMax, Object, undefined) {
		...
		DRU: [
			{
				...
				spellDamage: level => spellValues.blizzard[level] + (my.level),
				spellVariance: .85,
				spellType: 'evocation',
				damageType: 'cold',
				castTime: 5,
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Hits 3x targets for X arcane damage - Reduces threat.',
			}, {
				name: 'Tornado',
				img: 'DRU-8',
				mp: level => spellValues.tornadoMana[level],
				spellDamage: level => spellValues.tornado[level] + (my.level),
				spellVariance: .875,
				spellType: 'conjuration',
				damageType: 'fire',
				castTime: 3,
				cooldownTime: 0,
				description: 'Hits a random target for X arcane damage - slows target 50% for X seconds.',
			}, {
				name: 'Nature\'s Touch',
				img: 'DRU-9',
				mp: level => spellValues.starfireMana[level],
	...
	const spellValues = {
		...
		blizzardMana: getManaTier(1.3),
		blizzard: [0, 6, 17, 40, 73, 108, 139, 162],
		toxicSporesMana: getManaTier(1.4),
		toxicSpores: [0, 16, 40, 96, 172, 254, 328, 382],
		moltenBoulderMana: getManaTier(1.4),
		moltenBoulder: [0, 14, 35, 84, 151, 223, 287, 335],
		barbedThicketMana: getManaTier(1.6),
		barbedThicket: [0, 10, 25, 60, 108, 159, 205, 239],
		tornadoMana: getManaTier(2),
		tornado: [0, 36, 90, 216, 387, 572, 738, 860],
		naturesTouchMana: getManaTier(1.5),
		naturesTouch: [0, 16, 40, 96, 172, 254, 328, 382],
		mossBreathMana: getManaTier(1.2),
		mossBreath: [0, 10, 25, 60, 108, 159, 205, 239],
		synthesizeMana: getManaTier(.8),
		synthesize: [0,1,2,3,4,5,6,7],
		branchSpiritMana: getManaTier(1.6),
		branchSpirit: [0, 26, 65, 156, 280, 413, 533, 621],
		// wiz

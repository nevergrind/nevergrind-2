		...
		WIZ: [
			{
				...
				name: 'Counterspell',
				img: 'WIZ-11',
				sp: level => spellValues.counterspellMana[level],
				spellDamage: level => spellValues.counterspell[level] + (my.level * 1),
				spellVariance: .825,
				spellType: 'alteration',
				damageType: 'arcane',
				castTime: 3,
				...
				name: 'Brain Freeze',
				img: 'WIZ-12',
				sp: level => spellValues.brainFreezeMana[level],
				spellDamage: level => spellValues.brainFreeze[level] + (my.level * 1),
				spellVariance: .825,
				spellType: 'alteration',
				damageType: 'arcane',
				castTime: 3,
				cooldownTime: 0,
				description: 'Hit a single target for X ice damage - X ice damage plus slows target casting speed by 50% (?), lowers ice, fire, lightning, arcane resists by X for X seconds.',
			},
		],
	}

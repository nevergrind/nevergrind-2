		...
		WIZ: [
			{
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Hits single target 3 times for X arcane damage.',
			}, {
				name: 'Fireball',
				img: 'WIZ-5',
				mp: level => spellValues.smiteMana[level],
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Hits all targets for X ice damage and reduces taunt.',
			}, {
				name: 'Meteor',
				img: 'WIZ-8',
				mp: level => spellValues.smiteMana[level],
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Hits 5x targets for X fire damage plus X fire damage over X seconds.',
			}, {
				name: 'Ice Block',
				img: 'WIZ-9',
				mp: level => spellValues.smiteMana[level],

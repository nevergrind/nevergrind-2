...
!function($, _, TweenMax, Object, undefined) {
		...
		WAR: [
			{
				...
				enhancedDamage: [0, .45, .54, .63, .72, .81, .9, .99],
				hitBonus: [0, 5.5, 6, 6.5, 7, 7.5, 8, 8.5],
				critBonus: [0, -.5, 0, .5, 1, 1.5, 2, 2.5],
				cooldownTime: 0,
				...
				hitBonus: [0, -4.5, -4, -3.5, -3, -2.5, -2, -1.5, -1],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 15,
				...
				hitBonus: [0, 2.5, 3, 3.5, 4, 4.5, 5, 5.5],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 24,
				...
				enhancedDamage: [0, .65, .71, .77, .83, .89, .95, 1.01],
				hitBonus: [0, 4, 4.5, 5, 5.5, 6, 6.5, 7],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 16,
		...
		CRU: [
			{
				...
				enhancedDamage: [0, .56, .64, .72, .8, .88, .96, 1.04],
				hitBonus: [0, 4, 4.5, 5, 5.5, 6, 6.5, 7],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 30,
				...
				enhancedDamage: [0, .45, .51, .57, .63, .69, .75, .81],
				hitBonus: [0, 1, 1.5, 2, 2.5, 3, 3.5, 4],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 15,
				...
				enhancedDamage: [0, .9, .99, 1.08, 1.17, 1.26, 1.33, 1.42],
				hitBonus: [0, 5.5, 6, 6.5, 7, 7.5, 8, 8.5],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				requiresFrontRow: true,
				cooldownTime: 8,
		...
		SHD: [
			{
				...
				enhancedDamage: [0, .57, .66, .75, .84, .93, 1.02, 1.13],
				hitBonus: [0, -.5, 0, .5, 1, 1.5, 2, 2.5],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 0,
				description: 'Bash your target (+50% bonus damage when shield equipped) Effect: Reduces target\'s armor',
			}, {
				name: 'Death Strike',
				img: 'SHD-2',
				mp: level => spellValues.deathStrikeMana[level],
				enhancedDamage: [0, .7, .8, .9, 1, 1.1, 1.2, 1.3],
				hitBonus: [0, 1, 1.5, 2, 2.5, 3, 3.5, 4],
				critBonus: [0, -2, -1.5, -1, -.5, 0, .5, 1],
				cooldownTime: 12,
				description: 'Single-target strike that leaches a percentage of damage as health',
			}, {
				name: 'Crescent Cleave',
				img: 'SHD-3',
				mp: level => spellValues.crescentCleaveMana[level],
				enhancedDamage: [0, .7, .76, .82, .88, .94, 1, 1.04],
				hitBonus: [0, -4, -3.5, -3, -2.5, -2, -1.5, -1],
				critBonus: [0, 2.5, 3, 3.5, 4, 4.5, 5, 5.5],
				cooldownTime: 9,
				...
				enhancedDamage: [0, .76, .85, .94, 1.03, 1.14, 1.23, 1.32],
				hitBonus: [0, 4, 4.5, 5, 5.5, 6, 6.5, 7],
				critBonus: [0, -2, -1.5, -1, -.5, 0, .5, 1],
				cooldownTime: 10,
				...
				castTime: 3,
				cooldownTime: 20,
				description: 'Summon a hail of astral blades that slice up to 5 targets.',
			}, {
				...
				castTime: 3,
				cooldownTime: 0,
				description: 'Strikes targets with poison damage; DoT hits for x damage for x ticks',
			}, {
				name: 'Decaying Doom',
				img: 'SHD-7',
				...
				castTime: 3.5,
				cooldownTime: 0,
				description: 'Hits single target for X arcane damage; Effect: Debuff armor by 15%',
			}, {
				name: 'Blood Terror',
				img: 'SHD-8',
				...
				castTime: 3.5,
				cooldownTime: 30,
				description: 'Hits target for x blood damage over X seconds; Effect: Fears target.',
			}, {
				name: 'Life Tap',
				img: 'SHD-9',
				...
				castTime: 3,
				cooldownTime: 30,
				description: 'Single-target arcane health drain - Cannot be resisted.',
			}, {
				name: 'Vampiric Feast',
				img: 'SHD-10',
				...
				castTime: 4.5,
				cooldownTime: 0,
				description: 'Buffs health gained on kill and all physical attacks have a chance to recover health.',
			}, {
				...
				castTime: 2.5,
				cooldownTime: 0,
				description: 'An unholy curse ignites a single target - Effect: +hit, +crit on target.',
			}
		],
		RNG: [
			{
				...
				hitBonus: [0, 2, 2.5, 3, 3.5, 4, 4.5, 5],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				requiresFrontRow: true,
				cooldownTime: 0,
				...
				hitBonus: [0, -5, -4.5, -4, -3.5, -3, -2.5, -2],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 20,
				...
				hitBonus: [0, 7, 7.5, 8, 8.5, 9, 9.5, 10],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 30,
				...
				hitBonus: [0, -7, -6.5, -6, -5.5, -5, -4.5, -4],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 24,
				...
				hitBonus: [0, 1.5, 2, 2.5, 3, 3.5, 4, 4.5],
				critBonus: [0, 0, 0, 0, 0, 0, 0, 0],
				cooldownTime: 16,
		...
		MNK: [
			{
				...
				enhancedDamage: [0, .76, .85, .94, 1.03, 1.12, 1.21, 1.3, 1.39],
				hitBonus: [0, .5, 1, 1.5, 2, 2.5, 3, 3.5],
				critBonus: [0, -4, -3.5, -3, -2.5, -2, -1.5, -1],
				cooldownTime: 0,
				...
				enhancedDamage: [0, .55, .64, .73, .82, .91, 1, 1.09],
				hitBonus: [0, 3, 3.5, 4, 4.5, 4, 4.5, 5],
				critBonus: [0, -8, -7.5, -7, -6.5, -6, -5.5, -5],
				cooldownTime: 7,
				...
				enhancedDamage: [0, .6, .67, .74, .81, .88, .95, 1.02],
				hitBonus: [0, 6, 6.5, 7, 7.5, 8, 8.5, 9],
				critBonus: [0, -2, -1.5, -1, -.5, 0, .5, 1],
				cooldownTime: 20,
				...
				enhancedDamage: [0, .93, 1.02, 1.11, 1.2, 1.29, 1.38, 1.47],
				hitBonus: [0, -4, -3.5, -3, -2.5, -2, -1.5, -1],
				...
				enhancedDamage: [0, .36, .4, .44, .48, .52, .56, .6],
				critBonus: [0, 6.5, 7, 7.5, 8, 8.5, 9, 9.5],
				cooldownTime: 21,
				...
				enhancedDamage: [0, .88, .97, 1.06, 1.15, 1.24, 1.33, 1.42],
				critBonus: [0, 1.5, 2, 2.5, 3, 3.5, 4, 4.5],
				cooldownTime: 12,
		...
		ROG: [
			{
				...
				name: 'Manic Strike',
				img: 'ROG-4',
				mp: level => spellValues.manicStrikeMana[level],
				enhancedDamage: getSkillValues(.5, .09),
				hitBonus: getSkillValues(1, .5),
				critBonus: getSkillValues(3, .5),
				cooldownTime: 30,
				...
				name: 'Stagger Shot',
				img: 'ROG-8',
				mp: level => spellValues.staggerShotMana[level],
				enhancedDamage: getSkillValues(.5, .09),
				hitBonus: getSkillValues(1, .5),
				critBonus: getSkillValues(3, .5),
				cooldownTime: 30,
				...
				name: 'Evade',
				img: 'ROG-9',
				sp: level => spellValues.evadeMana[level],
				enhancedDamage: getSkillValues(.5, .09),
				hitBonus: getSkillValues(1, .5),
				critBonus: getSkillValues(3, .5),
				cooldownTime: 30,
				...
				name: 'Flash Powder',
				img: 'ROG-10',
				sp: level => spellValues.flashPowderMana[level],
				enhancedDamage: getSkillValues(.5, .09),
				hitBonus: getSkillValues(1, .5),
				critBonus: getSkillValues(3, .5),
				cooldownTime: 30,
				...
				name: 'Talisman',
				img: 'ROG-11',
				sp: level => spellValues.talismanMana[level],
				enhancedDamage: getSkillValues(.5, .09),
				hitBonus: getSkillValues(1, .5),
				critBonus: getSkillValues(3, .5),
				cooldownTime: 30,
		...
		WLK: [
			{
				...
				castTime: 3,
				cooldownTime: 8,
				description: 'Hit single target for X arcane damage - drains health to yourself - Cannot be resisted',
			}, {
				name: 'Lich Form',
				img: 'WLK-10',
				...
				img: 'WLK-12',
				sp: level => 0,
				spellDamage: level => my.buffs.profaneSpirit.damage,
				spellType: PROP.ALTERATION,
				damageType: DAMAGE_TYPE.POISON,
				castTime: 0,
				cooldownTime: 0,
	...
	const spellValues = {
		...
		manicStrikeMana: getManaTier(1.2),
		lacerateMana: getManaTier(1.4),
		backstabMana: getManaTier(1.3),
		widowStrikeMana: getManaTier(1.2),
		staggerShotMana: getManaTier(1.5),
		evadeMana: getManaTier(.8),
		flashPowderMana: getManaTier(1.4),
		talismanMana: getManaTier(1.2),
		...
		vampiricAllure: NoDamage,
		borealTalismanMana: getManaTier(1.8),
		borealTalisman: NoDamage,
		// DRU
		...
		bindingGraceMana: getManaTier(1.9),

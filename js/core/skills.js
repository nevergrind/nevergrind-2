...
!function($, _, TweenMax, Object, undefined) {
		...
		ENC: [
			{
				...
				castTime: 2,
				cooldownTime: 30,
				description: 'Hits all targets with a nova of X arcane damage - stuns all targets for X seconds.',
			}, {
				name: 'Phase Blade',
				img: 'ENC-6',
				...
				name: 'Stasis Field',
				img: 'ENC-7',
				sp: level => spellValues.stasisFieldMana[level],
				...
				name: 'Shifting Ether',
				img: 'ENC-8',
				sp: level => spellValues.shiftingEtherMana[level],
				...
				name: 'Rune',
				img: 'ENC-9',
				sp: level => spellValues.runeMana[level],
				spellDamage: level => spellValues.rune[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
				...
				spellDamage: level => spellValues.enthrall[level] + (my.level),
				spellVariance: .875,
				spellType: 'evocation',
				damageType: 'fire',
				castTime: 3,
	...
	const spellValues = {
		...
		shiftingEtherMana: getManaTier(1.2),
		shiftingEther: [0, 15, 37, 89, 159, 235, 303, 354],
		runeMana: getManaTier(1.2),
		rune: [0, 15, 37, 89, 159, 235, 303, 354],
		augmentationMana: getManaTier(1.2),
		augmentation: [0, 15, 37, 89, 159, 235, 303, 354],
		clarityMana: getManaTier(1.2),
		clarity: [0, 15, 37, 89, 159, 235, 303, 354],
		enthrallMana: getManaTier(1.2),
		enthrall: [0, 15, 37, 89, 159, 235, 303, 354],
		// WLK

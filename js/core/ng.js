...
!function($, TweenMax, SplitText, _, Power2, undefined) {
	ng = {
		...
		jobLong: {
			[JOB.BARD]: CLASS.BARD,
			[JOB.CLERIC]: CLASS.CLERIC,
			[JOB.DRUID]: CLASS.DRUID,
			[JOB.ENCHANTER]: CLASS.ENCHANTER,
			[JOB.TEMPLAR]: CLASS.TEMPLAR,
			[JOB.MONK]: CLASS.MONK,
			[JOB.WARLOCK]: CLASS.WARLOCK,
			[JOB.CRUSADER]: CLASS.CRUSADER,
			[JOB.RANGER]: CLASS.RANGER,
			[JOB.ROGUE]: CLASS.ROGUE,
			[JOB.SHADOW_KNIGHT]: CLASS.SHADOW_KNIGHT,
			[JOB.SHAMAN]: CLASS.SHAMAN,

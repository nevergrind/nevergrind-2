...
!function($, _, TweenMax, undefined) {
	buffs = {
		...
		sealOfRedemption: {
			...
			job: JOB.CLERIC,
			duration: 720,
			resistBlood: [0, 4, 7, 10, 13, 16, 19, 22],
		...
		manaShell: {
			...
			resistBlood: [0, 2, 3, 4, 6, 7, 8, 10],
			resistPoison: [0, 2, 3, 4, 6, 7, 8, 10],
			resistArcane: [0, 2, 3, 4, 6, 7, 8, 10],
			resistLightning: [0, 2, 3, 4, 6, 7, 8, 10],
			resistFire: [0, 2, 3, 4, 6, 7, 8, 10],
			resistIce: [0, 2, 3, 4, 6, 7, 8, 10],
			knockback: 10,

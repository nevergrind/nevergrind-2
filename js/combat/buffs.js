...
!function($, _, TweenMax, undefined) {
	buffs = {
		...
		lichForm: {
			...
			job: JOB.WARLOCK,
			duration: 720,
			damageReduced: [0, .12, .14, .16, .18, .2, .22, .24],
		...
		celestialFrenzy: {
			...
			duration: 900,
			msg: () => 'You feel celestial vibrations resonate into a cerebral frenzy.',
			fadeMsg: 'Your charismatic aura fades.'
		},
		bellow: { hate: 1.25 },
		sonicBoom: {
		...
		markOfRemphan: {
			...
			interval: 90,
			duration: 90,
			buffHitBonus: [0, .04, .05, .06, .07, .08, .09, .1],
			buffCritBonus: [0, .02, .025, .03, .035, .04, .045, .05],
			isDebuff: true,
			damageType: DAMAGE_TYPE.FIRE,
		},
		// MNK

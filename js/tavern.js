...
!function($, _) {
	...
	function init() {
		tips = {
			...
			monsterTypes: 'There are seven different monster types, though some believe that there are more. The seven types are humanoids, beasts, undead, giants, eldritch, dragonkin, and demons. The monster type can reveal strengths or weaknesses in terms of resistances. One example is that undead are known to be weak against blunt weapons. If you\'re venturing into a dungeon packed with undead creatures, arming yourself with blunt weapons is a great idea!',
